...
/* package Instant-0.1.0.0 */
#ifndef VERSION_Instant
#define VERSION_Instant "0.1.0.0"
#endif /* VERSION_Instant */
#ifndef MIN_VERSION_Instant
#define MIN_VERSION_Instant(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Instant */
...
#define CURRENT_COMPONENT_ID "Instant-0.1.0.0-inplace-insc_llvm"
