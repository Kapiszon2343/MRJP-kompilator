...
instance Print (Latte.Abs.TopDef' a) where
  prt i = \case
    ...
    Latte.Abs.ClassDef _ id_ classelems -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id_, doc (showString "{"), prt 0 classelems, doc (showString "}")])
    Latte.Abs.ClassExt _ id_1 id_2 classelems -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id_1, doc (showString "extends"), prt 0 id_2, doc (showString "{"), prt 0 classelems, doc (showString "}")])
...
instance Print (Latte.Abs.ClassElem' a) where
  prt i = \case
    Latte.Abs.Attribute _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString ";")])
    Latte.Abs.Method _ type_ id_ args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
...
instance Print (Latte.Abs.Stmt' a) where
  prt i = \case
    ...
    Latte.Abs.Ass _ var expr -> prPrec i 0 (concatD [prt 0 var, doc (showString "="), prt 0 expr, doc (showString ";")])
    Latte.Abs.Incr _ var -> prPrec i 0 (concatD [prt 0 var, doc (showString "++"), doc (showString ";")])
    Latte.Abs.Decr _ var -> prPrec i 0 (concatD [prt 0 var, doc (showString "--"), doc (showString ";")])
    ...
    Latte.Abs.For _ type_ id_ expr1 expr2 stmt1 stmt2 -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 type_, prt 0 id_, doc (showString "="), prt 0 expr1, doc (showString ";"), prt 0 expr2, doc (showString ";"), prt 0 stmt1, doc (showString ")"), prt 0 stmt2])
...
instance Print (Latte.Abs.Var' a) where
  prt i = \case
    Latte.Abs.IdentVar _ id_ -> prPrec i 0 (concatD [prt 0 id_])
    Latte.Abs.ArrayVar _ var expr -> prPrec i 0 (concatD [prt 0 var, doc (showString "["), prt 0 expr, doc (showString "]")])
    Latte.Abs.AttrVar _ var id_ -> prPrec i 0 (concatD [prt 0 var, doc (showString "."), prt 0 id_])
...
instance Print (Latte.Abs.New' a) where
  prt i = \case
    Latte.Abs.NewBase _ type_ -> prPrec i 0 (concatD [doc (showString "new"), prt 0 type_])
    Latte.Abs.NewArray _ new expr -> prPrec i 0 (concatD [prt 0 new, doc (showString "["), prt 0 expr, doc (showString "]")])

instance Print (Latte.Abs.Expr' a) where
  prt i = \case
    Latte.Abs.ENew _ new -> prPrec i 6 (concatD [prt 0 new])
    Latte.Abs.EVar _ var -> prPrec i 6 (concatD [prt 0 var])
